...
export function InputOTP({ className, containerClassName, ...props }: InputOTPProps): React.ReactElement {
    return <OTPInput className={className} containerClassName={cn("flex items-center gap-2 has-disabled:opacity-64 has-disabled:**:data-[slot=input-otp-slot]:shadow-none has-disabled:**:data-[slot=input-otp-slot]:before:shadow-none!", containerClassName)} data-slot="input-otp" spellCheck={false} {...props} />;
}
...
export function InputOTPGroup({
    ...
    return <div className={cn("flex items-center gap-2", className)} data-size={size} data-slot="input-otp-group" {...props} />;
}
...
export function InputOTPSeparator({ className, ...props }: React.ComponentProps<"div">): React.ReactElement {
    return <Separator className={cn("rounded-full bg-input data-[orientation=horizontal]:h-0.5 data-[orientation=horizontal]:w-3", className)} {...props} />;
}
